...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash(
                "You should soon receive an email allowing you to rest your \
                password. Please male sure to check your spam and trash \
                if you can't fond the email"
            )
            token = user.get_jwt()
            ...
            url_password_reset_request = url_password_reset(
